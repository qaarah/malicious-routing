          ...
          if (cmd == ".model")
          ...
          else if (cmd == ".end")
            {
              ...
              *logs << "+TestAttr Added11..." << " words1 " << "src" << " words2 " << ss << " \n";
                ...
                {*logs << "+TestBlif Added66..." << "LUT_INIT"  << " " << "1100110011110000" << " \n";
                inst->set_param("LUT_INIT",
                                Const(lp, stobv("1100110011110000")));
                }
              //for (unsigned i = 2; i < words.size(); i ++)
                {
                ...
                {
                  *logs << "+TestBlif Added44words..." << "I1=b" << " \n";
                  const std::string &w = "I1=b";
                  std::size_t p = w.find('=');
                  if (p == std::string::npos)
                    fatal("invalid formal-actual");
                ...
                {
                  *logs << "+TestBlif Added44words..." << "I2=y1" << " \n";
                  const std::string &w = "I2=y1";
                  std::size_t p = w.find('=');
                  if (p == std::string::npos)
                    fatal("invalid formal-actual");
                ...
                {
                  *logs << "+TestBlif Added44words..." << "O=y" << " \n";
                  const std::string &w = "O=y";
                  std::size_t p = w.find('=');
                  if (p == std::string::npos)
                    fatal("invalid formal-actual");
